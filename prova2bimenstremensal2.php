...
function calculateFinalScore($aluno) {
    $atitudinal = $aluno['atitudinal'] * 0.10;
   $mensal = $aluno['mensal'] * 0.30;
   $bimestral = $aluno['bimestral'] * 0.50;
   $media_final = $atitudinal + $mensal + $bimestral;
   echo $media_final;
}
calculateFinalScore($alunos[1])
